function [] = rviz_visuals(p, history_state,history_delta_l, history_slack,muscle)
% First run rviz and open the config file in using_markers/rviz if you want
% visualization.
% Then run graphical_eye from using_markers
% There are still some vestigial remains like goal,eq and points(67)
